...
export function TechStack() {
  return (
    <section className="px-8 max-w-screen-2xl mx-auto py-32 border-t border-white/5" id="tech-stack">
      <div className="mb-20 reveal">
        <span className="font-label text-[10px] tracking-[0.4em] uppercase text-white/40">Toolbox</span>
        <h2 className="font-headline text-5xl font-extrabold tracking-tighter mt-4">TECHNICAL ARSENAL</h2>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6">
        {/* Tech Item: React */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.1s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">React</span>
        </div>
        {/* Tech Item: Next.js */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.15s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">Next.js</span>
        </div>
        {/* Tech Item: Vue.js */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.2s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M24,1.6L12,22.4L0,1.6h4.8L12,14L19.2,1.6H24z M17,1.6L12,10.2L7,1.6H2.5L12,18l9.5-16.4H17z"/>
          </svg>
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">Vue.js</span>
        </div>
        {/* Tech Item: Figma */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.25s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">Figma</span>
        </div>
        {/* Tech Item: Git */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.3s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">Git</span>
        </div>
        {/* Tech Item: Express JS */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.35s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">Express JS</span>
        </div>
        {/* Tech Item: Vite.js */}
        <div className="glass-card p-8 flex flex-col items-center justify-center group hover:bg-white/10 transition-all duration-500 reveal" style={{ animationDelay: '0.4s' }}>
          <svg className="w-8 h-8 text-white/40 group-hover:text-white transition-colors mb-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-[9px] font-bold tracking-[0.2em] uppercase text-white/60 group-hover:text-white">Vite.js</span>
        </div>
      </div>
    </section>
  );
