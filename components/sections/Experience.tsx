        ...
        <div className="md:col-span-8 space-y-24 relative">
          ...
          <div className="md:pl-12 relative group reveal">
            ...
            <div className="glass-card p-10 hover:bg-white/5 transition-all duration-500 border border-white/10">
              ...
              <p className="text-white/40 font-light leading-relaxed max-w-2xl">
                Leading a high-performance team of 5 designers and developers.
                Spearheading the technical direction of award-winning digital
                experiences for global luxury brands. Focused on performance,
                accessibility, and high-fidelity motion design.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="glass-card p-10 hover:bg-white/5 transition-all duration-500 border border-white/10">
              ...
              <p className="text-white/40 font-light leading-relaxed max-w-2xl">
                Architected and maintained the core Design System used across 4
                enterprise products. Engineered complex real-time dashboards for
                financial monitoring, focusing on data visualization and modular
          ...
          >
            ...
            <div className="glass-card p-10 hover:bg-white/5 transition-all duration-500 border border-white/10">
              ...
              <p className="text-white/40 font-light leading-relaxed max-w-2xl">
                Executed full-stack development for rapid-growth consumer
                platforms. Specialized in custom CMS integrations and developing
                responsive, mobile-first user interfaces using emerging
