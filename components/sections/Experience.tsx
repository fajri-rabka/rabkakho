    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-15 lg:gap-20">
        <motion.div className="md:col-span-4" {...fadeInUp}>
          ...
          <h2 className="font-headline lg:text-6xl text-2xl font-extrabold tracking-tighter mt-4 text-on-background">
            EXPERIENCE
          </h2>
        </motion.div>
        <div className="md:col-span-8 space-y-10 lg:space-y-24 relative">
          ...
          {[
            ...
            >
              <div className="absolute -left-[4px] top-0 w-2.5 h-2.5 bg-on-background/20 border-4 border-background ring-1 ring-outline hidden md:block transition-all group-hover:bg-on-background group-hover:scale-150 rounded-full"></div>
