  ...
  return (
    <>
      <motion.nav
        ...
        className={`fixed z-50 left-1/2 -translate-x-1/2 bg-surface/80 backdrop-blur-xl lg:border-x border-b transition-colors duration-300`}
      >
        <div
        ...
        >
          ...
          <button
            ...
            className="hidden md:block bg-transparent border border-white rounded-full text-white px-6 py-2.5 text-[10px] font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-black active:scale-95 transition-all duration-300"
          >
            Get in Touch
          </button>
          ...
          <button
            ...
            className="hamburger flex xl:hidden"
          >
            <span></span>
            <span></span>
          </button>
